...
import { Sparkles, Diamond, CheckCircle } from "lucide-react";

export default function MakingProcessClient() {
  return (
      ...
      <div className="max-w-5xl mx-auto space-y-24 relative z-10">
        ...
        >
          <div className="badge-gold w-fit mx-auto">
            ...
            <span className="text-[10px] tracking-[0.2em] uppercase text-[#C9A84C] font-bold">Artisan Craft</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-light text-[#FAF7F2] leading-tight">
            Making <span className="font-display italic gold-gradient-text">Process</span>
          </h1>
          <p className="text-[#C4BAB0] font-light text-base md:text-lg leading-relaxed">
            Every diamond in the Vees Star Diamond collection is hand-selected and cut to the most exacting standards, guaranteeing a more brilliant diamond.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
             ...
             <h3 className="text-2xl font-light text-[#FAF7F2] mb-4">Rough Diamond Processing</h3>
             <p className="text-[#C4BAB0] text-sm leading-relaxed font-light">
               We process rough diamonds directly from the source. By controlling the transformation from raw stone to polished gem, we ensure unmatched purity and geometric perfection.
             </p>
          </motion.div>
          ...
          >
             ...
             <CheckCircle className="w-10 h-10 text-[#C9A84C] mb-6 mx-auto" />
             <h3 className="text-2xl font-light text-[#FAF7F2] mb-4">Uncompromising Quality</h3>
             <p className="text-[#C4BAB0] text-sm leading-relaxed font-light">
               Whether fulfilling large corporate requests or small bespoke orders, Vees Star Diamonds consistently delivers premium quality products that exceed expectations.
             </p>
          </motion.div>
