...
export default function BraceletsClient() {
  const items = [
    {
      id: 6,
      title: "Traditional Handcrafted Bangles",
      carats: "Diamond Clusters // Madras Gold Cast",
      url: "https://images.unsplash.com/photo-1599643477877-530eb83abc8e?auto=format&fit=crop&w=500&q=80",
      aspect: "h-[310px]"
    },
    {
      id: 9,
      title: "Tennis Bracelet - Eternity Setting",
      carats: "4.5 Carat Total // PT950 Platinum",
      url: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?auto=format&fit=crop&w=500&q=80",
      aspect: "h-[400px]"
    },
    {
      id: 10,
      title: "The Heritage Cuff",
      carats: "Polki Diamonds // 22K Gold",
  ...
  const handleWhatsAppInquiry = (item) => {
    const msg = `Hi Vees Star Diamonds! I saw the bracelet "${item.title}" (${item.carats}) in your gallery and would like to inquire about its availability and customization.`;
    ...
    <div className="relative min-h-screen bg-[#0E0C0A] text-[#FAF7F2] pt-[180px] pb-16 px-6 md:px-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-12 relative z-10">
        ...
        <div className="flex flex-wrap items-center space-x-2 text-[10px] tracking-widest uppercase font-bold text-[#7A6E66]">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-[#C9A84C]">Bracelets</span>
        </div>
        ...
        >
          <div className="badge-gold">
            ...
            <span className="text-[10px] tracking-[0.2em] uppercase text-[#C9A84C] font-bold">Wristwear</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-light text-[#FAF7F2] leading-tight">
            Diamond <span className="font-display italic gold-gradient-text">Bracelets</span>
          </h1>
        </motion.div>
